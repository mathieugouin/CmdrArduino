...
DCCPacketQueue::DCCPacketQueue(uint8_t length) : read_pos(0), write_pos(0), size(length), written(0)
{
...
DCCRepeatQueue::DCCRepeatQueue(uint8_t length) : DCCPacketQueue(length)
{
}
...
DCCEmergencyQueue::DCCEmergencyQueue(uint8_t length) : DCCPacketQueue(length)
{
}
